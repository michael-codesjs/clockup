...
export type Mutation = {
  __typename?: 'Mutation';
  createAlarm: AlarmResponse;
  deleteUser: OperationOutput;
  updateAlarm: AlarmResponse;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createAlarm?: Resolver<ResolversTypes['AlarmResponse'], ParentType, ContextType, RequireFields<MutationCreateAlarmArgs, 'input'>>;
  deleteUser?: Resolver<ResolversTypes['OperationOutput'], ParentType, ContextType>;
  updateAlarm?: Resolver<ResolversTypes['AlarmResponse'], ParentType, ContextType, RequireFields<MutationUpdateAlarmArgs, 'input'>>;
