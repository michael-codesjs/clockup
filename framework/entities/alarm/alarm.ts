import { Alarm as AlarmType, AlarmRingTime, AlarmSnoozeSettings, EntityType, ICommom } from "@local-types/api";
...
import { AlarmAttributes, EntityErrorTypes, NullAlarmAttributes } from "../types";
